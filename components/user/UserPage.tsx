...
import { PLAYER_INFO } from "../../frontend-react/src/graphql/queries/playerInfo";
import { SEARCH_FOR_BUILDS } from "../../frontend-react/src/graphql/queries/searchForBuilds";
import {
  SearchForUserData,
  SearchForUserVars,
  SEARCH_FOR_USER,
} from "../../frontend-react/src/graphql/queries/searchForUser";
