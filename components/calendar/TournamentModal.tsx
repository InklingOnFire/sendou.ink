...
} from "../../frontend-react/src/graphql/mutations/deleteCompetitiveFeedEvent";
import {
  UpdateCompetitiveFeedEventVars,
  UPDATE_COMPETITIVE_FEED_EVENT,
} from "../../frontend-react/src/graphql/mutations/updateCompetitiveFeedEvent";
import {
  CompetitiveFeedEvent,
  UPCOMING_EVENTS,
} from "../../frontend-react/src/graphql/queries/upcomingEvents";
